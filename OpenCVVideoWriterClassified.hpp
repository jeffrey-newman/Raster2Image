...
#ifndef GEON_OPT_OPENCVVIDEOWRITERCLASSIFIED_HPP
#define GEON_OPT_OPENCVVIDEOWRITERCLASSIFIED_HPP
...
class OpenCVVideoWriterClassified {
...
private:
    ...
    OpenCVWriterClassified raster_img_writer;
    std::vector<cv::Mat> frames;


public:
    OpenCVVideoWriterClassified(ColourMapper & _colour_map, int _fps = 1, bool _do_timestamp = false, int _year_start = 0, int _font_size =192, unsigned int _origin_x = 0,
...
//            : saver((AnimatedGifSaver *) nullptr), is_initialised(false),
    ...
    OpenCVVideoWriterClassified(BuiltinColourMaps _colour_map_id, int _fps = 1, bool _do_timestamp = false, int _year_start = 0, int _font_size =192, unsigned int _origin_x = 0,
                                unsigned int _origin_y = 0, unsigned int _dx = 999999, unsigned int _dy = 999999)
//            : saver((AnimatedGifSaver *) nullptr), is_initialised(false),
...
#endif //GEON_OPT_OPENCVVIDEOWRITERCLASSIFIED_HPP
